        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingFee = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountValue = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountAmount = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
                    SnapshotTitle = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SnapshotIsbn = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SnapshotCoverUrl = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    SnapshotAuthorNames = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarrierStatus = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiscountApplied = table.Column<decimal>(type: "decimal(15,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlashSales_StartTime_EndTime_IsActive",
                table: "FlashSales",
